...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.132 2025-10-31 14:53:55 GMT")
...
{	struct blackJackns__getStatus soap_tmp_blackJackns__getStatus;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__getStatus(soap, soap_tmp_blackJackns__getStatus.playerName, soap_tmp_blackJackns__getStatus.gameIndex, soap_tmp_blackJackns__getStatusResponse.gameStatus);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
...
{	struct blackJackns__playerMove soap_tmp_blackJackns__playerMove;
	...
	soap_default_blackJackns__tBlock(soap, &soap_tmp_blackJackns__tBlock);
	soap_tmp_blackJackns__playerMoveResponse.playerMove = &soap_tmp_blackJackns__tBlock;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__playerMove(soap, soap_tmp_blackJackns__playerMove.playerName, soap_tmp_blackJackns__playerMove.gameIndex, soap_tmp_blackJackns__playerMove.move, soap_tmp_blackJackns__playerMoveResponse.playerMove);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
