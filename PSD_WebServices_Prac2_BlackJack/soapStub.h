...
struct tMessage;	/* blackJack.h:60 */
struct tDeck;	/* blackJack.h:66 */
struct tBlock;	/* blackJack.h:72 */
struct blackJackns__registerResponse;	/* blackJack.h:78 */
struct blackJackns__register;	/* blackJack.h:78 */
struct blackJackns__getStatusResponse;	/* blackJack.h:79 */
struct blackJackns__getStatus;	/* blackJack.h:79 */
struct blackJackns__playerMoveResponse;	/* blackJack.h:80 */
struct blackJackns__playerMove;	/* blackJack.h:80 */
...
struct blackJackns__getStatus {
        /** Required element 'playerName' of XML schema type 'blackJackns:tMessage' */
        struct tMessage playerName;
        /** Required element 'gameIndex' of XML schema type 'xsd:int' */
        int gameIndex;
};
#endif
...
struct blackJackns__playerMoveResponse {
        /** Optional element 'playerMove' of XML schema type 'blackJackns:tBlock' */
        struct tBlock *playerMove;
};
#endif
...
struct blackJackns__playerMove {
        ...
        /** Required element 'gameIndex' of XML schema type 'xsd:int' */
        int gameIndex;
        /** Required element 'move' of XML schema type 'xsd:unsignedInt' */
        unsigned int move;
};
#endif
...
\******************************************************************************/
    ...
    SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__getStatus(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int gameIndex, struct tBlock *gameStatus);
    ...
    SOAP_FMAC5 int SOAP_FMAC6 soap_send_blackJackns__getStatus(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int gameIndex);
    ...
    SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__playerMove(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int gameIndex, unsigned int move, struct tBlock *playerMove);
    ...
    SOAP_FMAC5 int SOAP_FMAC6 soap_send_blackJackns__playerMove(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int gameIndex, unsigned int move);
    ...
    SOAP_FMAC5 int SOAP_FMAC6 soap_recv_blackJackns__playerMove(struct soap *soap, struct tBlock *playerMove);
...
\******************************************************************************/
    ...
    SOAP_FMAC5 int SOAP_FMAC6 blackJackns__getStatus(struct soap*, struct tMessage playerName, int gameIndex, struct tBlock *gameStatus);
    /** Web service operation 'blackJackns__playerMove' implementation, should return SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 blackJackns__playerMove(struct soap*, struct tMessage playerName, int gameIndex, unsigned int move, struct tBlock *playerMove);
